...
router.get("/auth/me", async (req: Request, res: Response): Promise<void> => {
  ...
  const rows = await db
    .select({
      ...
      companyUlica: companiesTable.ulica,
      companyPostna: companiesTable.postnaStevika,
      companyKraj: companiesTable.kraj,
  ...
  res.json({
    ...
    companyUlica: uporabnik.companyUlica ?? null,
    companyPostna: uporabnik.companyPostna ?? null,
    companyKraj: uporabnik.companyKraj ?? null,
